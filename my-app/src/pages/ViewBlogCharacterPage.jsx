        ...
        <>
          <Layout className="border min-h-screen">
            ...
            >
              {
                collapsed === false && (
                  <div className={'flex justify-end'}>
                    <Button className={'!border-r-0 !bg-amber-400'}
                            icon=<LeftOutlined/>
              ...
              <div className="text-center py-4 font-bold">
                {collapsed ? (
                  <>
                    <div>
                      <RelatedBlogIcon hasBlog={blogComic !== null} blogComic={blogComic} blogCharacterId={blog.id}/>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    {
                        <RelatedBlog hasBlog={blogComic !== null} blogComic={blogComic} blogCharacterId={blog.id}/>
                    }
            ...
            </Sider>
            {
              collapsed === true && (
                <div className={'flex justify-end'}>
                  <Button className={'!border-0 !rounded-l-none   !bg-amber-400'}
                          icon=<RightOutlined/>
